...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (tokenA.chainId == exports.ChainId.BSCMAIN) {
    ...
    } else if (tokenA.chainId == exports.ChainId.BSCTEST) {
      factory_address = CAKE_FACTORY_ADDRESS_TEST;
      init_code_hash = CAKE_INIT_CODE_HASH_TEST;
    } else if (tokenA.chainId == exports.ChainId.POLYGON) {
...
exports.Trade = Trade;
exports.UNI_FACTORY_ADDRESS = UNI_FACTORY_ADDRESS;
exports.UNI_INIT_CODE_HASH = UNI_INIT_CODE_HASH;
exports.WETH = WETH;
