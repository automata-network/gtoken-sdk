...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'CON-V2', 'Conveyor V2');
...
export { CAKE_FACTORY_ADDRESS_MAIN, CAKE_FACTORY_ADDRESS_TEST, CAKE_INIT_CODE_HASH_MAIN, CAKE_INIT_CODE_HASH_TEST, ChainId, Currency, CurrencyAmount, ETHER, Fetcher, Fraction, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, UNI_FACTORY_ADDRESS, UNI_INIT_CODE_HASH, WETH, currencyEquals, inputOutputComparator, tradeComparator };
